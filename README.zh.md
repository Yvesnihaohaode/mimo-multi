...
- [视觉回退](#视觉回退)
- [安装](#安装)
  - [Docker（一键使用）](#docker一键使用)
  - [自动安装（推荐本地开发）](#自动安装推荐本地开发)
  - [手动安装（5 步）](#手动安装5-步)
- [使用方式](#使用方式)
  - [方式一：手动启动](#方式一手动启动安装完即可用无需额外配置)
  - [方式二：一键启动 + 切换模型](#方式二一键启动--切换模型推荐)
- [Windows](#windows)
  - [安装](#安装-1)
  - [一键启动 + 切换模型（PowerShell）](#一键启动--切换模型powershell)
- [与上游 mimo2codex 的区别](#与上游-mimo2codex-的区别)
- [上游同步](#上游同步)
- [许可证](#许可证)
